  ...
  fields: [
        ...
        const optionsChanged =
          ...
          value.some((option) => {
            return (
              ...
              !previousValue?.some(
                (prevOption) =>
                  (prevOption as any).medusa_id === option.medusa_id,
              )
            );
          });
    ...
    },
    {
      ...
      validate: (value: any, { req, previousValue }) => {
        ...
        const changedVariants =
          ...
          value.some((variant: any) => {
            return (
              ...
              !previousValue?.some(
                (prevVariant: any) =>
                  prevVariant.medusa_id === variant.medusa_id,
              )
            );
          });
        ...
        return (
          !changedOptionValues || "Option values cannot be changed in number"
        );
      },
    },
  ],
